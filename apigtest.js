        ...
        $("#search-box").submit(function(event) {
            ...
            $.ajax({
                ...
                for (var i = 0; i < results.length; i++) {
                  ...
                  var recipeDiv = $('<div class="col-md-4 col-sm-6 results-item">'+
                        '<a class="results-link" data-toggle="modal" href="#resultsModal"'+i+'">'+
                            '<div class="results-hover">' +
                                '<div class="results-hover-content">' +
                                    '<i class="fa fa-plus fa-3x"></i>' +
                                '</div>' +
                            '</div>' +
                            '<img class="img-fluid" src="'+results[i].recipe.image+'" alt="">' +
                        '</a>' +
                        '<div class="results-caption">' +
                            '<h4>'+results[i].recipe.label+'</h4>' +
                            '<p class="text-muted">Flavor Text</p>' +
                        '</div>' +
                    '</div>');
